...
export default function SingIn() {
  ...
  return (
    <main className="bg-slate-50 flex w-screen h-screen place-items-center justify-center flex-col gap-10">
      ...
      <button onClick={handleSingIn} className="transition ease-in-out flex items-center gap-2 border border-slate-950 text-slate-950 rounded-full px-4 py-2 hover:bg-slate-950 hover:text-slate-50">
